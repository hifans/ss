...
const MEDIA_QUERIES = {
  ...
  SM_TO_MD: `(min-width: ${tailwindBreakpoints.sm}px) and (max-width: ${
    tailwindBreakpoints.md - 1
  }px)`,
  SM_TO_LG: `(min-width: ${tailwindBreakpoints.sm}px) and (max-width: ${
    tailwindBreakpoints.lg - 1
  }px)`,
  SM_TO_XL: `(min-width: ${tailwindBreakpoints.sm}px) and (max-width: ${
    tailwindBreakpoints.xl - 1
  }px)`,
  SM_TO_2XL: `(min-width: ${tailwindBreakpoints.sm}px) and (max-width: ${
    tailwindBreakpoints["2xl"] - 1
  }px)`,

  MD_TO_LG: `(min-width: ${tailwindBreakpoints.md}px) and (max-width: ${
    tailwindBreakpoints.lg - 1
  }px)`,
  MD_TO_XL: `(min-width: ${tailwindBreakpoints.md}px) and (max-width: ${
    tailwindBreakpoints.xl - 1
  }px)`,
  MD_TO_2XL: `(min-width: ${tailwindBreakpoints.md}px) and (max-width: ${
    tailwindBreakpoints["2xl"] - 1
  }px)`,

  LG_TO_XL: `(min-width: ${tailwindBreakpoints.lg}px) and (max-width: ${
    tailwindBreakpoints.xl - 1
  }px)`,
  LG_TO_2XL: `(min-width: ${tailwindBreakpoints.lg}px) and (max-width: ${
    tailwindBreakpoints["2xl"] - 1
  }px)`,

  XL_TO_2XL: `(min-width: ${tailwindBreakpoints.xl}px) and (max-width: ${
    tailwindBreakpoints["2xl"] - 1
  }px)`,

  // Legacy names (kept for backwards compatibility)
  MOBILE: `(max-width: ${tailwindBreakpoints.sm - 1}px)`,
  TABLET: `(min-width: ${tailwindBreakpoints.sm}px) and (max-width: ${
    tailwindBreakpoints.lg - 1
  }px)`,
